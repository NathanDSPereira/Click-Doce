...
export default function Footer() {
    return (
      <footer className="bg-(--bg-creme) px-4 space-y-8 mb-5 max-w-7xl mx-auto">
        <div>
          <div className="border-t border-(--text-chocolate) text-base font-sans text-center font-medium text-(--text-chocolate) leading-none pt-8 mb-10">
          ...
          <ul className="flex flex-wrap gap-4 justify-center items-center">
            <li className="flex justify-center items-center">
              <a href="https://wa.me/5534997298335?text=Olá!%20Gostaria%20de%20fazer%20um%20pedido." target="_blank" rel="noopener noreferrer" className="flex justify-center items-center  w-32 h-16">
                <button className="flex justify-center items-center cursor-pointer  bg-(--accent-green) shadow-sm text-(--text-chocolate) w-full h-full rounded-2xl text-sm font-bold active:scale-95 transition-all active:border-(--accent-green)">
                  <MessageCircle
                    size={16}
        ...
        <div className="mt-16 pt-8 border-t border-zinc-900/50 flex flex-col items-center gap-4 text-center">
          <div className="space-y-1">
            <p className="text-zinc-500 text-[10px] uppercase tracking-[0.2em]">
              © 2026 Click & Doce - Todos os direitos reservados
            </p>
          ...
          <p className="text-zinc-500 text-[10px] tracking-wide">
            Desenvolvido por <span className="text-(--text-chocolate) font-medium hover:text-amber-500 transition-colors cursor-pointer">Nathan Pereira</span>
          </p>
        </div>
      </footer>
    )
